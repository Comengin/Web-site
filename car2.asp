...
<body>
    ...
    <center>
    	<div id="contentplace">
    		...
    		<div class="image"><img src="audi.jpg" width="70%" height="70%" alt="resim2" usemap="#resim2" >
    			<map name="resim2">
						<area shape="rect" coords="0,0,1000,600" alt="face" href="ALLENLOPEZ.asp">
				</map>
    			<div class="tables">
	    		...
	    		<input type="hidden" name="control" value="album2">
