...
<head>
	...
	<link rel="shortcut icon" href="lamborghini.png">
</head>
<body>
	<div class="header">
        <div class="container">
	        ...
	        <div class="navigation">
	        	<ul>
		            ...
		            <li class="current"><a href="album.asp">Album</a></li>
    ...
    <div class="comeback">
    	<a href="album.asp"><img src="comeback.png"></a>
    </div>
    <center>
    	<div id="contentplace">
    		<% if session("login") <> "" then %>
    		<div class="image"><img src="lamborghini.jpg" width="70%" height="70%" alt="resim4" usemap="#resim4">
    			<map name="resim4">
						<area shape="rect" coords="0,0,1000,600" alt="face" href="RIVERAWILSON.asp">
				</map>
    			<div class="tables">
	    		...
	    		<input type="hidden" name="control" value="album4">
			...
			<%
				...
				sql="select * from tables where type='album'"
				data.Open sql, conn
