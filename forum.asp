...
<head>
	...
	<link rel="shortcut icon" href="forum.png">
</head>
<body>
	<div class="header">
        <div class="container">
	        ...
	        <div class="navigation">
	        	<ul>
		            ...
		            <li class="current"><a href="forum.asp">Forum</a></li>
    ...
    <center>
	    <div id="contenofforum">
			...
			conn.Open"Provider=Microsoft.Jet.OLEDB.4.0; Data Source=" & Server.MapPath("comments.mdb")%>
				...
				<input type="hidden" name="control" value="forum">
				<input type="submit" value="Send" class="sendcomment" style="cursor: pointer;">
					<table cellpadding="8px" border="2">
						<tr style="color: white; background-color: rgb(24, 32, 58);">
							<th>ID</th>
							<th>NAME</th>
							<th>COMMENT</th>
							<th>DATE</th>
			...
			sql="select * from tables where type='forum'"
			data.Open sql, conn
