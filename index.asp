...
<head>
	...
	<link rel="shortcut icon" href="home.jpg">
</head>
<body>
	<div class="header">
        <div class="container">
    ...
    <div class="background">
      <div class="container">
        <h1>Automobile industry in Germany</h1>
        <p>The automotive industry in Germany is one of the largest employers in the world, with a labor force of over 857336 (2016) working in the industry.</p>
      </div>
    </div>
    ...
    <div class="sidebar">
	    <div class="container">
			<ul>
				<li><a href="#c1">History</a></li>
				<li><a href="#c2">Early history</a></li>
				<li><a href="#c3">Postwar era</a></li>
				<li><a href="#c4">1970s</a></li>
				<li><a href="#c5">1980s and 1990s</a></li>
				<li><a href="#c6">21st century</a></li>
			</ul>
		</div>
	</div>
	<div class="content">
		<h1 id="c1">History</h1>
		<p>
			The automotive industry in Germany is one of the largest employers in the world, with a labor force of over 857336 (2016) working in the industry.
			...
			German-designed cars won in the European Car of the Year, the International Car of the Year, the World Car of the Year annual awards the most times among all countries. The Volkswagen Beetle and Porsche 911 took 4th and 5th places in the Car of the Century award.<a href="#"><img src="yukariok.png"></a>
		</p>
		<div class="contentphoto"><img src="statistic.jpg" width="35%"></div>
		<h3 id="c2"><b>Early history</b></h3>
		<p>	
		...
		<p>
			...
			During the 1980s and 1990s, the German auto industry engaged in major acquisitions and international expansion all over the world. Besides of direct export, German manufacturers found or bought plants in European, Asian, Latin American countries and in the United States even. Auto industry of Mexico, Brazil, China, Turkey, some post-socialist East European countries gained by German investments in a significant share.<div class="contentphoto"><img src="diagram.png" align="right"></div>
			...
			At the beginning of 1990s, Ford and Volkswagen agreed a venture to produce an MPV together at the same factory with the same basic design. The result of this venture was the Ford Galaxy and Volkswagen Sharan, but these vehicles were produced in Portugal rather than Germany from their launch in 1995. They were joined a year later by the SEAT Alhambra.<a href="#"><img src="yukariok.png"></a>
		</p>
		<h3 id="c6"><b>21st century</b></h3>
		<p> <div class="contentphoto"><img src="new.jpg" align="left"></div>
			...
			The Chevrolet Volt and its GM Voltec powertrain Technology were invented and developed first and foremost by the former German Opel engineer Frank Weber and—still today—some of the most important parts of the development of GM's electric vehicles is done in Germany.<a href="#"><img src="yukariok.png"></a>
		</p>
	</div>
	<div class="footer">
