...
<body>
    ...
    <center>
    	<div id="contentplace">
    		...
    		<div class="image"><img src="BMW2.jpg" width="70%" height="70%" alt="resim" usemap="#resim" >
    			<map name="resim">
						<area shape="rect" coords="0,0,1000,500" alt="face" href="KENNEDYRODRIGUEZ.asp">
				</map>
    			<div class="tables">
	    		...
	    		<input type="hidden" name="control" value="album1">
