...
<body>
    ...
    <center>
	    <div id="videocontent">
	    	...
	    	<h2><span class="highlight">Lamborghini</span> Aventador</h2>
	    		<iframe  src="https://www.youtube.com/embed/UZiHPLGh-Ek?autoplay=1" frameborder="0"></iframe>
	    	<div class="tables">
	    		...
	    		<input type="hidden" name="control" value="video1">
