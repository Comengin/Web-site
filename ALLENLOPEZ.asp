...
<head>
	<meta charset="utf-8">
	<title>ALLEN LOPEZ</title>
	<link rel="stylesheet" type="text/css" href="main.css">
	<link rel="shortcut icon" href="personfemale.png">
</head>
<body>
	<div class="header">
        <div class="container">
