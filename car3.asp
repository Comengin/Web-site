...
<head>
	...
	<link rel="shortcut icon" href="mercedes.png">
</head>
<body>
	<div class="header">
        <div class="container">
    ...
    <center>
    	<div id="contentplace">
    		...
    		<div class="image"><img src="mercedes.jpg" width="70%" height="70%" alt="resim3" usemap="#resim3">
    			<map name="resim3">
						<area shape="rect" coords="0,0,1000,600" alt="face" href="CRUZMITCHELL.asp">
				</map>
    			<div class="tables">
	    		...
	    		<input type="hidden" name="control" value="album3">
